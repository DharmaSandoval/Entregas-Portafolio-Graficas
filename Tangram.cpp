    ...
    float verticesTriangulosColores[] = {
        ...
        //   x     y     z    R    G    B
           -0.5f, 0.5f, 0.0f,  0, 255, 0,
            0.5f, 0.5f, 0.0f,  0, 255, 0,  // TRIANGULO VERDE
            0.0f, 0.0f, 0.0f,  0, 255, 0,

            0.5f, 0.5f, 0.0f, 255, 0, 0,
            0.0f, 0.0f, 0.0f, 255, 0, 0,   // TRIANGULO ROJO
            0.5f, 0.0f, 0.0f, 255, 0, 0,

            0.5f,  0.0f, 0.0f, 255, 0, 255,
            0.5f, -0.3f, 0.0f, 255, 0, 255,  // TRAPECIO 1
            0.2f,  0.0f, 0.0f, 255, 0, 255,

            0.5f,  0.0f, 0.0f, 255, 0, 255,
            0.5f, -0.3f, 0.0f, 255, 0, 255,  // TRAPECIO 2
            0.8f, -0.3f, 0.0f, 255, 0, 255,

            0.5f,  0.5f, 0.0f, 0, 0, 255,
            0.7f,  0.3f, 0.0f, 0, 0, 255,  // CUBO 1
            0.7f,  0.7f, 0.0f, 0, 0, 255,

            0.7f,  0.30f, 0.0f, 0, 0, 255,
            0.7f,  0.70f, 0.0f, 0, 0, 255,  // CUBO 2
            0.9f,  0.5f,  0.0f, 0, 0, 255,

            0.0f, 0.0f, 0.0f, 255, 255, 0,
           -0.7f, 0.7f, 0.0f, 255, 255, 0,  // TRIANGULO AMARILLO
           -0.7f, 0.0f, 0.0f, 255, 255, 0,

           -0.7f,  0.05f, 0.0f, 0, 255, 255,
           -0.9f, -0.15f, 0.0f, 0, 255, 255,  // TRIANGULO MORADO
           -0.7f, -0.35f, 0.0f, 0, 255, 255,

            0.70f, 0.7f, 0.0f, 128,128,128,
            0.30f, 0.7f, 0.0f, 128,128,128,  // TRIANGULO BLANCO
            0.50f, 0.90f, 0.0f, 128,128,128,
